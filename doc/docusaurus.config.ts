...
import rehypeAnsiToHtml from './src/plugins/rehype-ansi-to-html.mjs';

const config: Config = {
  title: 'provider',
  tagline: 'Dynamic Dispatch with Traits',
  ...
  projectName: 'provider', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/mbarbin/provider/tree/main/doc/',
          rehypePlugins: [rehypeAnsiToHtml],
        },
        blog: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/mbarbin/provider',
          label: 'GitHub',
          position: 'right',
        },
      ],
